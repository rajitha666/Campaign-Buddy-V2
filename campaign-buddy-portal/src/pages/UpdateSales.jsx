...
export default function UpdateSales() {
  ...
  const filterSlot = (
    <div className="filter-bar">
      ...
      <div className="filter-field"><label>{applyDesignationLabel('Promoter', designationLabel)}</label>
        <SearchableSelect options={staffOptions} value={form.staffId} onChange={(v) => setForm((f) => ({ ...f, staffId: v }))} placeholder={`Search ${applyDesignationLabel('promoters', designationLabel)}…`} />
      </div>
