...
`phone` doubles as a **mobile-app login identifier** — CB Mobile accepts either the mobile number (any common Sri Lankan format, normalised to the local form `0771234567`) or the legacy app username (issue #3). Enter it in any format; it is stored canonical, and unique among active staff (issue #22).
